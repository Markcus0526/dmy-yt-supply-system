...
namespace YiTongBackend.Models.LINQHelper
{
    public static class DataTableHelper
    {
        ...
        public static void BulkCopyToDatabase<T>(this IEnumerable<T> source, string tableName, System.Data.Linq.DataContext databaseContext) where T : class
        {
            ...
            {
                using (var bulkCopy = new SqlBulkCopy(System.Configuration.ConfigurationManager.ConnectionStrings["PLMobileConnectionString"].ConnectionString, SqlBulkCopyOptions.KeepIdentity & SqlBulkCopyOptions.KeepNulls))
                {
