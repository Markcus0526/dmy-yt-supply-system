...
<div class="portlet">
	<div class="portlet-body" style="display: block;">
	    <div class="table-toolbar">
		    <div class="btn-group">
                <a href="<%= ViewData["rootUri"] %>Advert/AddAdvert" class="btn default"><i class="fa fa-plus"></i> 添加公告信息</a>
		    </div>
	...
	<script>
	    ...
	    var handleDataTable = function () {
	        ...
	        oTable = $('#tbllist').dataTable({
	            "bServerSide": true,
	            "bProcessing": true,
	            "sAjaxSource": rootUri + "Advert/RetrieveAdvertList",
	            "oLanguage": {
	            ...
	            "aoColumnDefs": [
                    ...
                    },
                    {
                        aTargets: [2],
                        fnRender: function (o, v) {
                            var retstr = '<img style="width :300px;" src="' + rootUri + o.aData[2] + '" />';
                            return retstr;
                        },
                        sClass: 'tableCell'
                    },

                    {
                        ...
                        fnRender: function (o, v) {
                            ...
                            var retstr = '<a href="<%= ViewData["rootUri"] %>Advert/EditAdvert/' + o.aData[4] + '" title="编辑" class="btn default btn-xs blue-stripe tooltips"><i class="fa fa-edit"></i> </a>&nbsp;&nbsp;' +
                                '<a href="javascript:void(0);" onclick="return deleteAdvert(' + o.aData[4] + ');" title="删除"  class="btn default btn-xs dark-stripe tooltips"><i class="fa fa-trash-o"></i></a>';
                            return retstr;
                        },
                        sClass: 'tableCell'
                    }
	        ...
	        bootbox.dialog({
	            ...
	            buttons: {
	                ...
	                main: {
	                    ...
	                    callback: function () {
	                        $.ajax({
	                            url: rootUri + "Advert/DeleteAdvert",
	                            data: {
	                                "id": id
	                            },
	                            type: "post",
	        ...
	        bootbox.dialog({
	            ...
	            buttons: {
	                ...
	                main: {
	                    ...
	                    callback: function () {
	                        $.ajax({
	                            url: rootUri + "Advert/DeleteSelectedAdvert",
	                            data: {
	                                "ids": ids
	                            },
	                            type: "post",
