...
<form action="#" id="submit_form" class="form-horizontal form-validate">
	<div class="form-body">
        ...
        <div class="form-group">
			<label class="control-label col-md-2" for="postcontent">公告内容<span class="required">*</span></label>
			<div class="col-md-5">
				<input type="text" name="postcontent" id="postcontent" placeholder="请输入公告内容" data-required="1" class="form-control" 
                    value="<% if (ViewData["postcontent"] != null) { %><%= ViewData["postcontent"] %><% } %>"/>
			</div>
		</div>
        <div class="form-group">
			<label class="control-label col-md-2" for="viewurl">链接URL<span class="required">*</span></label>
			<div class="col-md-5">
				<input type="text" name="viewurl" id="viewurl" placeholder="请输入链接URL" data-required="1" class="form-control" 
                    value="<% if (ViewData["viewurl"] != null) { %><%= ViewData["viewurl"] %><% } %>"/>
			</div>
		</div>
        <div class="form-group">
			<label class="control-label col-md-2" for="isvisible">是否显示<span class="required">*</span></label>
			<div class="col-md-3">
				<div class="make-switch" data-on-label="显示" data-off-label="不显示">
					<input type="checkbox" id="isvisible" name="isvisible" 
                        <% if (ViewData["isvisible"] != null && ViewData["isvisible"].ToString() == "1") { %> checked <% } %> class="toggle"/>
				</div>
			</div>
		</div>            
    ...
    <div id="ajax-modal" class="modal fade" tabindex="-1">P
    </div>
    ...
    <script>
        ...
        function redirectToListPage(status) {
            if (status.indexOf("error") != -1) {
                ...
                window.location = rootUri + "Post/Post";
            }
        }
