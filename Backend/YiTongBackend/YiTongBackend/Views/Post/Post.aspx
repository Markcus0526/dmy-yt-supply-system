...
<div class="portlet">
	<div class="portlet-body" style="display: block;">
	    <div class="table-toolbar">
		    <div class="btn-group">
                <a href="<%= ViewData["rootUri"] %>Post/AddPost" class="btn default"><i class="fa fa-plus"></i> 添加信息</a>
		    </div>
    ...
    <script>
        ...
        var handleDataTable = function () {
            ...
            oTable = $('#tbllist').dataTable({
                "bServerSide": true,
                "bProcessing": true,
                "sAjaxSource": rootUri + "Post/RetrievePostList",
                "oLanguage": {
                ...
                "aoColumnDefs": [
                    ...
                    },
                    {
                        ...
                        fnRender: function (o, v) {
                            ...
                            var retstr = '<a href="<%= ViewData["rootUri"] %>Post/EditPost/' + o.aData[5] + '" title="编辑" class="btn default btn-xs blue-stripe tooltips"><i class="fa fa-edit"></i> </a>&nbsp;&nbsp;' +
                                '<a href="javascript:void(0);" onclick="return deletePost(' + o.aData[5] + ');" title="删除"  class="btn default btn-xs dark-stripe tooltips"><i class="fa fa-trash-o"></i></a>';
                            return retstr;
                        },
                        sClass: 'tableCell'
                    }
            ...
            bootbox.dialog({
                ...
                buttons: {
                    ...
                    main: {
                        ...
                        callback: function () {
                            $.ajax({
                                url: rootUri + "Post/DeleteSelectedPost",
                                data: {
                                    "ids": ids
                                },
                                type: "post",
